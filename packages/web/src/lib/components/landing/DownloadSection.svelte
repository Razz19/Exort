<script lang="ts">
  ...
  import {
    EXORT_APP_VERSION,
    EXORT_GITHUB_RELEASES_DOWNLOAD_LINK,
  } from "$lib/constant";
  ...
  const versionedDownloadPath = (suffix: string) =>
    `${EXORT_GITHUB_RELEASES_DOWNLOAD_LINK}/v${EXORT_APP_VERSION}/Exort-${EXORT_APP_VERSION}-${suffix}`;

  const downloads = [
    {
      label: "macOS Apple Silicon",
      file: `Exort-${EXORT_APP_VERSION}-mac-arm64.dmg`,
      href: versionedDownloadPath("mac-arm64.dmg"),
      icon: appleIcon,
      color: "#98971a",
    },
    {
      label: "macOS Intel",
      file: `Exort-${EXORT_APP_VERSION}-mac-x64.dmg`,
      href: versionedDownloadPath("mac-x64.dmg"),
      icon: appleIcon,
      color: "#458588",
    },
    {
      ...
      href: versionedDownloadPath("win-x64.zip"),
      icon: windowsIcon,
      color: "#fe8019",
    },
    {
      label: "Linux",
      file: `Exort-${EXORT_APP_VERSION}-linux-x86_64.AppImage`,
      href: versionedDownloadPath("linux-x86_64.AppImage"),
      icon: linuxIcon,
      color: "#d79921",
    },
  ];
  const downloadVersion = EXORT_APP_VERSION;
...
<section
  id="try-exort"
  class="relative w-full overflow-hidden pt-0 pb-4 lg:pb-6"
>
  <div class="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-8">
    <div
      bind:this={ctaSection}
      class="px-4 pb-4 pt-0 sm:px-10 sm:pb-10 sm:pt-0 lg:px-12 lg:pb-12 lg:pt-0"
    >
      <div
        class="flex min-h-[22rem] flex-col items-center justify-center text-center"
      >
        <div bind:this={ctaIntroEl} class="max-w-3xl pt-10">
          <span
...
{#if showInstallationGuide}
  <section
    ...
    class="mx-auto w-full max-w-7xl px-6 pb-6 pt-12 lg:px-8 lg:pb-10"
  >
                  ...
                  <div class="min-w-0 flex-1 space-y-2">
                    ...
                    <div class="mt-3 min-w-0">
                      ...
                      <div class="mt-4 bg-gruvbox-ink p-4">
                        ...
                        >
                          <p>
                            You're gonna see security warnings because Exort is
                            not notarized yet. This is expected for apps
                              ...
                              <div class="min-w-0">
                                ...
                                >
                                  <p>
                                    ...
                                    launch Spotlight, type "Terminal", and hit
                                    Enter)
                                    <br />
                      ...
                      <div class="p-4 mt-10">
                        <div class="flex items-start gap-3">
                          <div class="min-w-0 flex-1 space-y-2">
                            ...
                            <div
                              class="mt-0 sm:mt-3 grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(17rem,1fr)] xl:items-start"
                            >
                              <div class="min-w-0">
                                <div
                                  class="space-y-3 pt-10 text-sm sm:text-lg leading-7 text-gruvbox-muted"
              ...
              <section class="bg-gruvbox-bg p-4 sm:p-5">
                <div class="flex items-start gap-4">
                  <div class="min-w-0 flex-1 space-y-2">
                    ...
                    >
                      <p>
                        You can now open Exort from the Applications folder or
                        spotlight.
                        <br />
                  ...
                  <div class="min-w-0 flex-1 space-y-2">
                    ...
                    >
                      <div class="min-w-0">
                        ...
                        >
                          <p>
                            - On the next window, click "Run anyway" to proceed
                            with installation.
                          </p>
                        </div>
                      </div>
                  ...
                  <div class="min-w-0 flex-1 space-y-2">
                    ...
                    >
                      <p>
                        ...
                        <br />
                        - You won’t see any more security warnings after this, and
                        you can launch Exort from the Start menu or desktop shortcut.
                      </p>
                    </div>
                  </div>
                </div>
